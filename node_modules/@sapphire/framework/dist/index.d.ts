...
import { ChatInputApplicationCommandData, UserApplicationCommandData, MessageApplicationCommandData, ApplicationCommandManager, Collection, ApplicationCommand, Message, BaseCommandInteraction, DMChannel, Guild, CategoryChannel, NewsChannel, ThreadChannel, StageChannel, TextChannel, VoiceChannel, GuildMember, PartialDMChannel, Role, User, Snowflake, CommandInteraction, ContextMenuInteraction, Permissions, TextBasedChannel, AutocompleteInteraction, PermissionResolvable, PermissionString, ClientOptions, Interaction, Client, ClientEvents } from 'discord.js';
import { ArgumentStream, IUnorderedStrategy, Lexer } from '@sapphire/lexure';
import { AliasPiece, Piece, AliasPieceJSON, PieceContext, AliasStore, PieceOptions, PieceJSON, Store, StoreRegistry } from '@sapphire/pieces';
 ...
 */
declare type ArgumentResult<T> = Result<T, ArgumentError<T>>;
/**
 ...
 */
declare type AwaitableArgumentResult<T> = Awaitable<ArgumentResult<T>>;
/**
 * Defines an asynchronous result of an {@link Argument}, check {@link Argument.Result} for the synchronous version.
 */
declare type AsyncArgumentResult<T> = Promise<ArgumentResult<T>>;
...
declare function resolveChannel(parameter: string, messageOrInteraction: Message | BaseCommandInteraction): Result<ChannelTypes, Identifiers.ArgumentChannelError>;
...
declare function resolveDMChannel(parameter: string, messageOrInteraction: Message | BaseCommandInteraction): Result<DMChannel, Identifiers.ArgumentChannelError | Identifiers.ArgumentDMChannelError>;
...
declare type ResultType<T> = Result<T, UserError | ArgumentError<T>>;
declare type ArrayResultType<T> = Result<T[], UserError | ArgumentError<T>>;
...
declare class CorePrecondition$d extends AllFlowsPrecondition {
    ...
    chatInputRun(interaction: CommandInteraction, command: Command, context: CooldownPreconditionContext): AllFlowsPrecondition.Result;
    contextMenuRun(interaction: ContextMenuInteraction, command: Command, context: CooldownPreconditionContext): AllFlowsPrecondition.Result;
    private sharedRun;
...
declare class CorePrecondition$c extends AllFlowsPrecondition {
    ...
    chatInputRun(interaction: CommandInteraction, _: Command, context: PermissionPreconditionContext): AllFlowsPrecondition.AsyncResult;
    contextMenuRun(interaction: ContextMenuInteraction, _: Command, context: PermissionPreconditionContext): AllFlowsPrecondition.AsyncResult;
    private sharedRun;
...
declare class CorePrecondition$b extends AllFlowsPrecondition {
    ...
    chatInputRun(interaction: CommandInteraction): AllFlowsPrecondition.Result;
    contextMenuRun(interaction: ContextMenuInteraction): AllFlowsPrecondition.Result;
}
...
declare class CorePrecondition$a extends AllFlowsPrecondition {
    ...
    chatInputRun(_: CommandInteraction, command: Command, context: AllFlowsPrecondition.Context): AllFlowsPrecondition.Result;
    contextMenuRun(_: ContextMenuInteraction, command: Command, context: AllFlowsPrecondition.Context): AllFlowsPrecondition.Result;
}

declare class CorePrecondition$9 extends AllFlowsPrecondition {
    private readonly allowedTypes;
    messageRun(message: Message): AllFlowsPrecondition.Result;
    chatInputRun(interaction: CommandInteraction): AllFlowsPrecondition.AsyncResult;
    contextMenuRun(interaction: ContextMenuInteraction): AllFlowsPrecondition.AsyncResult;
}
...
declare class CorePrecondition extends AllFlowsPrecondition {
    ...
    chatInputRun(interaction: CommandInteraction, _command: Command, context: PermissionPreconditionContext): AllFlowsPrecondition.Result;
    contextMenuRun(interaction: ContextMenuInteraction, _command: Command, context: PermissionPreconditionContext): AllFlowsPrecondition.Result;
    private sharedRun;
}
...
declare type InteractionHandlerParseResult<Instance extends InteractionHandler> = Option.UnwrapSome<Awaited<ReturnType<Instance['parse']>>>;
