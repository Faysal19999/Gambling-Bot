...
exports.getCommandDifferences = exports.getCommandDifferencesFast = void 0;
const v10_1 = require("discord-api-types/v10");
const optionTypeToPrettyName = new Map([
    [v10_1.ApplicationCommandOptionType.Subcommand, 'subcommand'],
    [v10_1.ApplicationCommandOptionType.SubcommandGroup, 'subcommand group'],
    [v10_1.ApplicationCommandOptionType.String, 'string option'],
    [v10_1.ApplicationCommandOptionType.Integer, 'integer option'],
    [v10_1.ApplicationCommandOptionType.Boolean, 'boolean option'],
    [v10_1.ApplicationCommandOptionType.User, 'user option'],
    [v10_1.ApplicationCommandOptionType.Channel, 'channel option'],
    [v10_1.ApplicationCommandOptionType.Role, 'role option'],
    [v10_1.ApplicationCommandOptionType.Mentionable, 'mentionable option'],
    [v10_1.ApplicationCommandOptionType.Number, 'number option'],
    [v10_1.ApplicationCommandOptionType.Attachment, 'attachment option']
]);
const contextMenuTypes = [v10_1.ApplicationCommandType.Message, v10_1.ApplicationCommandType.User];
const subcommandTypes = [v10_1.ApplicationCommandOptionType.SubcommandGroup, v10_1.ApplicationCommandOptionType.Subcommand];
/**
...
function getCommandDifferences(existingCommand, apiData, guildCommand) {
    const differences = [];
    if (existingCommand.type !== v10_1.ApplicationCommandType.ChatInput && existingCommand.type) {
        // Check context menus
        if (contextMenuTypes.includes(existingCommand.type ?? v10_1.ApplicationCommandType.ChatInput)) {
...
function* reportOptionDifferences({ option, existingOption, currentIndex, keyPath = (index) => `options[${index}]` }) {
    ...
    if (subcommandTypes.includes(existingOption.type) && subcommandTypes.includes(option.type)) {
        ...
        if (castedExisting.type === v10_1.ApplicationCommandOptionType.SubcommandGroup &&
            castedExpected.type === v10_1.ApplicationCommandOptionType.SubcommandGroup) {
        ...
        else if (castedExisting.type === v10_1.ApplicationCommandOptionType.Subcommand &&
            castedExpected.type === v10_1.ApplicationCommandOptionType.Subcommand) {
            // 0. No existing options and now we have options
...
function hasMinMaxValueSupport(option) {
    return [v10_1.ApplicationCommandOptionType.Integer, v10_1.ApplicationCommandOptionType.Number].includes(option.type);
}
function hasChoicesAndAutocompleteSupport(option) {
    return [v10_1.ApplicationCommandOptionType.Integer, v10_1.ApplicationCommandOptionType.Number, v10_1.ApplicationCommandOptionType.String].includes(option.type);
}
function hasMinMaxLengthSupport(option) {
    return option.type === v10_1.ApplicationCommandOptionType.String;
}
