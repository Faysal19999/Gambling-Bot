...
exports.handleRegistryAPICalls = exports.getDefaultBehaviorWhenNotIdentical = exports.setDefaultBehaviorWhenNotIdentical = exports.acquire = exports.allGuildIdsToFetchCommandsFor = exports.registries = exports.defaultBehaviorWhenNotIdentical = void 0;
...
exports.defaultBehaviorWhenNotIdentical = Enums_1.RegisterBehavior.Overwrite;
exports.registries = new Map();
exports.allGuildIdsToFetchCommandsFor = new Set();
/**
...
function setDefaultBehaviorWhenNotIdentical(behavior) {
    exports.defaultBehaviorWhenNotIdentical = behavior ?? Enums_1.RegisterBehavior.Overwrite;
}
...
async function handleRegistryAPICalls() {
    ...
    const { applicationCommands, globalCommands, guildCommands } = await (0, getNeededParameters_1.getNeededRegistryParameters)(exports.allGuildIdsToFetchCommandsFor);
