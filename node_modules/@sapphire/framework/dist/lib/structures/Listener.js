...
class Listener extends pieces_1.Piece {
    ...
    async _run(...args) {
        ...
        const result = await result_1.Result.fromAsync(() => this.run(...args));
        result.inspectErr((error) => this.container.client.emit(Events_1.Events.ListenerError, error, { piece: this }));
    }
    async _runOnce(...args) {
