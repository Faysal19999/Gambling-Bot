...
class CommandStore extends pieces_1.AliasStore {
    ...
    async loadAll() {
        ...
        if (!this.container.client.application)
            return;
        const { applicationCommands, globalCommands, guildCommands } = await (0, getNeededParameters_1.getNeededRegistryParameters)(ApplicationCommandRegistries_1.allGuildIdsToFetchCommandsFor);
