...
class CoreArgument extends Argument_1.Argument {
    constructor(context) {
        ...
        this.messages = {
            ["numberTooSmall" /* Identifiers.ArgumentNumberTooSmall */]: ({ minimum }) => `The given number must be greater than ${minimum}.`,
            ["numberTooLarge" /* Identifiers.ArgumentNumberTooLarge */]: ({ maximum }) => `The given number must be less than ${maximum}.`,
            ["numberError" /* Identifiers.ArgumentNumberError */]: () => 'The argument did not resolve to a valid number.'
        };
    }
